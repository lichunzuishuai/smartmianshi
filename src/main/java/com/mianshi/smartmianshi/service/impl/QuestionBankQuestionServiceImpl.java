...
import com.mianshi.smartmianshi.mapper.QuestionBankQuestionMapper;
...
/*import com.mianshi.smartmianshi.model.entity.QuestionBankQuestionFavour;
import com.mianshi.smartmianshi.model.entity.QuestionBankQuestionThumb;*/
...
import com.mianshi.smartmianshi.service.QuestionBankQuestionService;
...
public class QuestionBankQuestionServiceImpl extends ServiceImpl<QuestionBankQuestionMapper, QuestionBankQuestion> implements QuestionBankQuestionService {
    ...
    /*    //检查那些题目还不存在于题库中，避免重复插入
        ...
        for (int i = 0; i <totalQuestionListSize; i+=batchSize) {
            ...
            //批处理操作优化
            /**
             * 在Spring中，事务管理是通过AOP代理实现的。当一个方法被标记为@Transactional时，
             * Spring会创建一个代理对象来拦截对该方法的调用，并在调用前后添加事务管理逻辑。
             * 在你的代码中，batchAddQuestionsToBankInner方法被同一个类中的batchAddQuestionToBank方法直接调用：
             * 这种调用方式被称为"内部调用"（self-invocation），在这种情况下，调用不会经过Spring的代理，
             * 因此@Transactional注解不会生效。
             */
